...
namespace Database_Library
{
    internal class DataGenerator
    {
        ...
        {
            return _firstNames[_random.Next(0, _firstNames.Length - 1)];
        }
        ...
        private uint GetPIN()
        {
            return Convert.ToUInt32(_random.Next(0, 9999));
        }

        private uint GetAcctNo()
        {
            return Convert.ToUInt32(_random.Next(100000000, 999999999));
        }

        private int GetBalance()
        {
            return _random.Next(-1000, 1000000);
        }

        private Bitmap GetIcon()
        {
            return _icons[_random.Next(0, _icons.Count - 1)];
        }
