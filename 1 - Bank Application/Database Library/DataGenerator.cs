...
namespace Database_Library
{
    internal class DataGenerator
    {
        ...
        private readonly string[] firstNames = new string[20] {
        ...
        private readonly string[] lastNames = new string[20] {
        ...
        private readonly List<Bitmap> icons;
        ...
        {
            return icons[random.Next(0, icons.Count - 1)];
        }
